...
social:
  - icon: graduation-cap # Alternatively, use `google-scholar` icon from `ai` icon pack
    icon_pack: fas
    link: https://scholar.google.com/citations?user=0cKXP7cAAAAJ&hl=en
  - icon: github
    icon_pack: fab
    link: https://github.com/vbharadwaj-bk 
  - icon: linkedin
    icon_pack: fab
    link: https://www.linkedin.com/in/vivek-bharadwaj-91135099/
  - icon: orcid 
    icon_pack: fab 
    link: https://orcid.org/0000-0003-0483-9578 
