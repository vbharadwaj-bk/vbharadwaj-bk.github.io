...
!figure(images/blog/wordlebot/lowres.png, small, "Aditi and I on a Spring day in Berkeley.", "This isn't an instagram filter...")

It looks a bit washed out, and the pixels are odd. Let's zoom in: 

!figure(images/blog/wordlebot/mediumres.png, small, "Clock tower closeup.", "A closeup of the Campanille.")

Huh... look at all those little squares... let's zoom in one more time...

!figure(images/blog/wordlebot/highres.png, small, "Wordle and Connections Results.", "Look familiar, New York Times readers?")
...
!figure(images/blog/wordlebot/iphone_shortcut.png, small, "Programming an iPhone shortcut.", "The shortcuts app lets you do all kinds of interesting automation.")
...
!figure(images/blog/wordlebot/spreadsheet.png, small, "A spreadsheet containing game results.", "The spreadsheet grows with every game you play.")
